            ...
            <dd class="pl-4">
             <?php 
                    if($date_from == $date_to){
                        echo date("M d, Y", strtotime($date_from))." ".date("H:i", strtotime($start_time))." - ".date("H:i", strtotime($end_time));
                    }else{
                        echo date("M d, Y H:i", strtotime($date_from." ".$start_time))." - ".date("M d, Y H:i", strtotime($date_to." ".$end_time));
                    }
                ?>
            </dd>
            <dt class="">Status</dt>
