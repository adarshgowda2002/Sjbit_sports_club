      ...
      <div class="card-body">
        <form id="register-frm" action="" method="post">
          ...
          <div class="row">
            ...
            <!--<div class="form-group col-md-6">
                <input type="text" name="middlename" id="middlename" placeholder="Enter Last Name (optional)" class="form-control form-control-sm form-control-border">
          ...
          <div class="row">
          <div class="form-group col-md-6">
                  <select name="role" id="role" class="custom-select custom-select-sm form-control-border" required>
                  <option>select</option>
                    <option>Faculty</option>
                    <option>Student</option>
                  </select>
                  <small class="ml-3">Role</small>
            </div>
            <div class="form-group col-md-6">
                <input type="text" name="roll" id="roll" placeholder="Enter USN/Staff ID" class="form-control form-control-sm form-control-border">
                <small class="ml-3">USN/Staff ID</small>
            </div>
            <div class="form-group col-md-6">
                  <select name="dept" id="dept" class="custom-select custom-select-sm form-control-border" required>
                  <option>select</option>
                    <option>CSE</option>
                    <option>ISE</option>
                    <option>ME</option>
          ...
          <div class="row">
            ...
            <div class="form-group col-md-6">
                <input type="text" name="contact" id="contact" maxlength ="10" placeholder="Enter Contact Number" class="form-control form-control-sm form-control-border" required>
          ...
          <div class="row">
            <div class="form-group col-md-12">
              ...
              <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0" placeholder="BGS & SJB Health & Education City, Uttarahalli Main Road, Kengeri, Bengalore, Karnataka 560060"></textarea>
            </div>
          </div>
          <hr>
          <div class="row">
            <div class="form-group col-md-6">
                <input type="email" name="email" id="email" placeholder="SJBIT@gmail.com" class="form-control form-control-sm form-control-border" required>
